...
class InventoryPage(BasePage):
    ...
    def add_a_product_to_cart(self, product_name):
        ...
        self.product_add_button_locator = (self.product_add_button_locator[0], self.product_add_button_locator[1].format(product_name))

        # Click on the button using the updated locator
        self.click(self.product_add_button_locator, 'Product add button locator not found before specified time out')
    ...
    def remove_a_product_to_cart(self, product_name):
        ...
        :return:
        """
        self.product_remove_button_locator = (self.product_remove_button_locator[0], self.product_remove_button_locator[1].format(product_name))
        self.click(self.product_remove_button_locator, 'Product remove button locator not found before specified time out')
